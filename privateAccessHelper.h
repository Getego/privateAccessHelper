...
/*      Copyright (©) 2016 by Georgios Terzoglou                                                */
...
/*                                                                                              */
/*                                                                                              */
/*      File: privateAccessHelper.h                                                             */
/*                                                                                              */
/*                                                                                              */
/*      State:		Release candidate [RC]                                                  */
/*      Date:		22.12.2016 [Last changes]                                               */
/*                                                                                              */
/*----------------------------------------------------------------------------------------------*/

#ifndef TEST_PRIVATEACCESSHELPER_H_
#define TEST_PRIVATEACCESSHELPER_H_
...
namespace
{
  ...
  {
    // \tparam TagType, used to declare different "get" funciton overloads for
...
#define PRIVATE_ACCESS_DETAIL_ACCESS_PRIVATE(Tag, Class, Type, Name, PtrTypeKind) \
  ...
  {                                                                               \
    ...
    {                                                                             \
       ...
       * Note, we could declare it inside the Tag type too, in that case ADL      \
       * would find the declaration. By choosing to declare it here, the Tag      \
       * type remains a simple tag type, it has no other responsibilities. */     \
    ...
    {                                                                             \
      ...
      */                                                                          \
      template <typename Obj,                                                     \
                ...
                Class>::value> * = nullptr,                                       \
                typename... Args>                                                 \
      auto Name(Obj &&o, Args &&... args) -> decltype((std::forward<Obj>(o).*     \
...
#endif /* TEST_PRIVATEACCESSHELPER_H_ */
